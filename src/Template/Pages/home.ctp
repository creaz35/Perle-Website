        ...
        <div id="main-slider" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="item active">
					<?= $this->Html->image('front-end/slider/bg1.jpg', ['class' => 'img-responsive', 'alt' => \Cake\Core\Configure::read('Site.name')]) ?>                      
    ...
    <section id="about">
      <div class="col-md-12">
        <div class="col-md-6">      
			<?= $this->Html->image('front-end/perles_mockup.png', ['class' => 'img-responsive', 'alt' => 'A propos de perle']) ?>
        </div>
    ...
    <section id="explore">
        <div class="container">
            <div class="row">
                <div class="watch">
					<?= $this->Html->image('front-end/watch.png', ['class' => 'img-responsive', 'alt' => 'Perle mobile application']) ?>
                </div>              
    ...
    <section id="contact">
        <div class="contact-section">
            <div class="ear-piece">
				<?= $this->Html->image('front-end/ear-piece.png', ['class' => 'img-responsive', 'alt' => 'Perle']) ?>
            </div>
            <div class="container">
                <div class="row">
